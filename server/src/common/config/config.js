...
module.exports = {
    default_module: 'api',
    weixin: {
        appid: 'wx51f8561785f579a8', // 小程序 appid
        secret: '6c7e29c4ac413d68c5cf08a36ffbdc9c', // 小程序密钥
   ...
   mianexpress:{
    ...
    qiniu: {
        access_key: 'hngh71R29yRS5QgFJYbm70Ssaao8gcF3jWv--npm',      // 在七牛密钥管理中获取
        secret_key: 'EOjFL82mNt51W19xtWlIFkgZRDFIR7_1-x4IFbo1',    // 在七牛密钥管理中获取
        bucket: 'hahaha123123',                    // 请填自己的bucket的名称
        domain: 'http://mini.sylvia.org.cn/'                         // 请填自己的domain域名
    },
    // 在七牛新建一个https的空间，这个是用来存储分享图片的https图片，对应的是goods表中的https_pic_url
    qiniuHttps: {
        access_key: 'hngh71R29yRS5QgFJYbm70Ssaao8gcF3jWv--npm', // 在七牛密钥管理中获取
        secret_key: 'EOjFL82mNt51W19xtWlIFkgZRDFIR7_1-x4IFbo1', // 在七牛密钥管理中获取
        bucket: 'hahaha123123', // 自己设置的
        domain: 'http://mini.sylvia.org.cn/', // 自己设置，例如：'http://img.你的域名.com/',别忘了这个”/“
